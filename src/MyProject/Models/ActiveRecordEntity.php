<?php
    ...
    public static function getPagesCount(int $itemsPerPage): int
    {
		...
		private function insert(array $mappedProperties): void
		{
			...
			$sql = 'INSERT INTO ' . static::getTableName() . '(' . implode(', ', array_flip($mappedPropertiesNotNull)) . ') 
				VALUES (' . implode(', ', array_flip($params2values)) . ');';
		...
		private
		function mapPropertiesToDbFormat(): array
		{
